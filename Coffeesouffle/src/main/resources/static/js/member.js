$(document).ready(function () {
    ...
    $('#mycanvas, #linkbt').on('click', function (e) {
        e.preventDefault();
        clickChange();
    });
    ...
    $('#loginButton').click(function () {
        // 獲取驗證碼輸入值
        var inputCode = $('#myvad').val().toLowerCase();
        var validCode = validate.toLowerCase();
    ...
    $('#updateButton').click(function () {
        ...
        if (!validatePattern(newPassword)) {
            Swal.fire({
                icon: 'error',
                iconColor: '#4CAF50',
                background: 'rgb(0,0,0)',
