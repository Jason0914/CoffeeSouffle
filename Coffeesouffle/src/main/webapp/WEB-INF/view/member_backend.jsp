                        ...
                        <tbody>
                            <c:forEach items="${memberList}" var="member">
                                <tr>
                                    ...
                                    <td>
                                       <!-- 修改按鈕 -->
<button class="btn btn-outline-primary btn-sm" type="button" onclick="window.editMember(${member.memberId})">
    <i class="fas fa-edit"></i> 修改
</button>
<!-- 刪除按鈕 -->
<button class="btn btn-outline-danger btn-sm" type="button" onclick="window.deleteMember(${member.memberId})">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="createEmployee" action="${pageContext.request.contextPath}/member_backend/" method="post">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="male" value="男生" checked>
                                            <label class="form-check-label" for="male">男生</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="female" value="女生">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="updateMale" value="男生">
                                        <label class="form-check-label" for="updateMale">男生</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="updateFemale" value="女生">
                                        <label class="form-check-label" for="updateFemale">女生</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="updatePhone" name="phone" pattern="09\d{8}" required>
                            </div>
                        </div>
                    </div>
