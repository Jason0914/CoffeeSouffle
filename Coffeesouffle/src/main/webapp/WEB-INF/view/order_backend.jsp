...
<body>
					...
					<div class="container-xxl p-0">
						...
						<nav class="collapse navbar-collapse" id="navbarMenu">
							<div class="header-buttons">
								<a class="header-btn" href="/index">首頁</a> <a href="/Charts"
									class="header-btn">財務狀況</a> <a class="header-btn"
									href="/order_backend">訂單管理</a> <a class="header-btn"
									href="/member_backend">員工管理</a> <a class="header-btn"
									href="/logout">登出</a>
							</div>
						</nav>
					</div>
						...
						<tbody>
							...
							<c:forEach items="${ orderList }" var="order">
								...
								<tr class="list-item">
									...
									<td>
										<form
											action="${ pageContext.request.contextPath }/order_backend/${ order.orderId }"
											id="delete-form" method="POST">
											<a
												href="${ pageContext.request.contextPath }/order_backend/${ order.orderId }"
												class="btn btn-outline-success details"
												data-bs-toggle="modal" data-bs-target="#detailsForm"
												data-bs-whatever="@mdo" data-id="${ order.orderId }"
	...
	<!-- 明細表單 -->
	<div class="modal fade" id="detailsForm" tabindex="-1"
